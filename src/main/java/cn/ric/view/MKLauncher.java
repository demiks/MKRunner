...
public class MKLauncher extends JFrame {
	...
	public static void main(String[] args) throws Exception {
		...
		helper.setMinimumSize(new Dimension(600, 500));
	...
	private void initFromINI() {
		setLocation(SETING.getInt("view-location-x", 180), SETING.getInt("view-location-y", 100));
		setSize(SETING.getInt("view-size-width", 0), SETING.getInt("view-size-height", 0));
	}
